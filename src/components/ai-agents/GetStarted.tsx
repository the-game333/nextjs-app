...
const GetStarted: React.FC<GetStartedProps> = () => {
  return (
    <section className="w-full my-12 text-center sm:my-20">
      ...
      <button className="w-full max-w-sm px-12 py-3 hover:-translate-y-[2px] active:translate-y-0 transition-all duration-500 text-base text-white bg-gradient-to-r from-yellow-100 via-yellow-300 to-yellow-500 rounded-xl">
        Contact Us
      </button>
    </section>
  );
