  ...
  return (
    <section className="my-12">
      <h1 className="py-2 mb-6 text-3xl font-semibold text-transparent sm:text-6xl bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 bg-clip-text">
        <span className="block">Secure AI assistant</span>
        <span className="block">with your company’s knowledge</span>
      </h1>
      <p className="text-base text-[#93A2B7] max-w-xl leading-normal">
        ...
        <br />
        <br />
        Dust is an AI assistant that safely brings the best large language models, continuously updated company knowledge, powerful
