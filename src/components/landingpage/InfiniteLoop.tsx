...
export default function InfiLoop() {
  ...
  useEffect(() => {
    ...
    // Clone the logos within the .logos_slide_right div
    ...
    //Set the animation duration based on the total number of logos
    const logosCount = logosContent.length * 2;
    const animationDuration = '30s';
    logosSlideRight.style.animationDuration = animationDuration;
