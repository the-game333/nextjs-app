...
const Partnership = () => {
  return (
    <div className="mx-auto px-3 md:max-w-5xl md:px-5 md:pb-20 md:pt-20 lg:max-w-6xl xl:px-0">
      <div id="main" className="grid grid-cols-1 justify-evenly gap-5 md:grid-cols-2 ">
        <div className="relative rounded-3xl border border-white p-8 dark:border-[#ffffff1a]">
          ...
          <div className="gap-4">
            ...
            <p className="relative mt-5 text-lg leading-6 text-white dark:text-[#C2C2C2] md:text-xl">
        ...
        <div className="relative rounded-3xl border border-white p-8 dark:border-[#ffffff1a]">
          ...
          <div className="gap-4">
            ...
            <p className="relative mt-5 text-lg leading-6 text-white  dark:text-[#C2C2C2] md:text-xl">Ready to use AI WebApp</p>
          </div>
          <div className="mt-6 gap-4">
      ...
      <div className="text-gray-600 dark:text-gray-300 mt-10" id="testimonials">
