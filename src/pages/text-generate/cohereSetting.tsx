...
const CohereSetting = (props: any) => {
    const { temperatureValue, setTemperatureValue, max_tokensValue, setMax_tokensValue, top_pValue, setTop_pValue, top_kValue, setTop_kValue, n, setNValue, presence_penalty, setPresence_penaltyValue, frequency_penalty, setFrequency_penaltyValue,  } = props;
    ...
    return (
        <Stack>
            ...
            <Box sx={{ width: 300 }}>
                <Typography id="input-top_kValue-slider" gutterBottom>
                    Top K
                </Typography>
                <Grid container spacing={2} alignItems="center">
                    <Grid item xs>
                        <Slider
                            ...
                            aria-label="Small"
                            aria-labelledby="input-top_kValue-slider"
                        />
                    </Grid>
                    <Grid item>
                        <Input
