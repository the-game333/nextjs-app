...
// action imports
import { redocumentSubmit, loadAlldocuments, rewebURLSubmit, } from 'actions/chatapplication';
...
const retrainApp = () => {
    ...
    useEffect(() => {
        init();
        if (router.isReady) {
            setFilename(String(router.query['filename']));
        }
    }, []);
    ...
    const submitFile = async () => {
        ...
        const result = await redocumentSubmit(data);
    ...
    const submitURL = async () => {
        ...
        const result = await rewebURLSubmit(filename, url);        
...
retrainApp.Layout = 'authGuard';
export default retrainApp;