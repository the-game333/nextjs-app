...
const ChatGPT = () => {
    ...
    const sendMessage = async () => {
        ...
        moveScroll("");
        const { data } = await getChatText(message, prompt || "");
        setTotalMessage((prev: []) => {
    ...
    return (
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12} lg={12} md={12}>
                <Paper sx={{ width: '100%', p: 5, height: "85vh", position: 'relative' }}>
                            ...
                            <TableBody sx={{ width: "100%", height: "75vh", overflow: "auto", display: "contents" }}>
                                ...
                                {totalMessage.length == 0 &&
                                    <StyledTableRow>
                                        <Stack direction={'row'} padding={5} spacing={2}>
                                            <Avatar src='/assets/images/logo_chat.png' alt='AI' />
                                            <Typography marginTop={"10px !important"}>Enter your message to start a chat. This could be a question, a statement, or any other text.</Typography>
                                        </Stack>
                                    </StyledTableRow>
                                }
                            </TableBody>
